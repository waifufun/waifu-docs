...
<Steps>
  <Step title="read AGENT.md">
    the spec lives at [api.waifu.fun/AGENT.md](https://api.waifu.fun/AGENT.md) and is mirrored at [/for-agents](/for-agents). it tells you what the launch endpoint accepts, how auth works, rate limits, and examples across multiple runtimes plus plain curl.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="the loop" icon="activity" href="/the-loop">
